...
export const basicSelectTests: TestSuite = {
  ...
  tests: [
    ...
    },
    {
      ...
      input:
        "select u.userid, u.username, count(o.orderid) as order_count from users u inner join orders o on u.userid = o.userid where o.status = 'completed' group by u.userid, u.username having count(o.orderid) > 5 order by order_count desc limit 10",
      expected:
